<template>
  <main>
    <section class="flex h-[80%] w-[80%] rounded-md bg-white shadow-lg max-sm:w-[94%]">
      <el-image src="src/assets/img/loginBg.jpg" fit="cover" class="w-1/2 max-md:hidden" />
      <div class="center w-full p-8 md:w-1/2">
        <FormLogin
          title="登入"
          ...
          <template #button>
            <div class="mt-5 flex items-center justify-between gap-4">
              <el-checkbox v-model="state.loginForm.rememberMe" label="記住我" />
